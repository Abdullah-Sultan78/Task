...
{{--
                        ...
                        <form enctype="multipart/form-data" action="{{route('cash_order')}}" class="checkout" method="post" name="checkout">
                            @csrf
...
{{--
                                        ...
                                        <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="text" value="{{Auth::user()->address}}" placeholder="Street address" id="billing_address_1" name="address" class="input-text ">
                                        </p>
...
{{--
                                        ...
                                        <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                            ...
                                            <input type="text" value="{{Auth::user()->phone}}" placeholder="" id="billing_phone" name="phone" class="input-text ">
                                        </p>
                                        <div class="clear"></div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-name">
                                              {{$cart->product->name}} <strong class="product-quantity">× {{$cart->quantity}}</strong> </td>
                                            <td class="product-total">
                                                <span class="amount">{{$cart->price}}</span> </td>
                                        </tr>
                                        @php
                                ...
                                <div id="payment">
                                    <ul class="payment_methods methods">
                                        {{-- <li class="payment_method_bacs">
                                            ...
                                            <label for="payment_method_bacs">Card Payment </label>
